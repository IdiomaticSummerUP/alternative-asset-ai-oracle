...
"[https://data-vault-api.idiomatic.workers.dev/api/v1/vault?sku=bordeaux-latour-2015](https://data-vault-api.idiomatic.workers.dev/api/v1/vault?sku=bordeaux-latour-2015)"
...
Bash
curl -H "X-Vault-API-Key: agent_premium_secret_abc123" \
"[https://data-vault-api.idiomatic.workers.dev/api/v1/vault?address=austin-tx](https://data-vault-api.idiomatic.workers.dev/api/v1/vault?address=austin-tx)"
Production Payload Response (application/json)
JSON
